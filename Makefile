...
OBJECT = $(SRC:.c=.o)
LIBFT = ft_strlen.c ft_strdup.c ft_strcpy.c ft_strncpy.c ft_strcat.c ft_strncat.c \
...
.PHONY: all $(NAME) $(LIBFT) $(SRC) clean fclean re src

all: $(NAME)

$(NAME): src $(LIBFT:.c=.o)
	ar rc $(NAME) $(OBJECT) $(LIBFT:.c=.o)
	ranlib $(NAME)
